...
public class AddAcademicExperienceRoleToPersonGenerator extends AddRoleToPersonTwoStageGeneratorGU {
    
    private static String TEMPLATE = "addAcademicExperienceRoleToPerson.ftl";
    ...
    @Override
    String getRoleType() {
        return "http://griffith.edu.au/ontology/hubextensions/AcademicExperienceRole";
    }
