...
public class AddExternalServiceRoleToPersonGenerator extends AddRoleToPersonTwoStageGeneratorGU {
    
    private static String TEMPLATE = "addExternalServiceRoleToPerson.ftl";
    ...
    @Override
    String getRoleType() {
        return "http://griffith.edu.au/ontology/hubextensions/ExternalServiceRole";
    }
