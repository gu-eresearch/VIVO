...
public class AddVisitingAppointmentRoleToPersonGenerator extends AddRoleToPersonTwoStageGeneratorGU {
    
    private static String TEMPLATE = "addVisitingAppointmentRoleToPerson.ftl";
    ...
    @Override
    String getRoleType() {
        return "http://griffith.edu.au/ontology/hubextensions/VisitingAppointmentRole";
    }
