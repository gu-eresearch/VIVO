...
public class AddMembershipOfProfessionalOrganisationRoleToPersonGenerator extends AddRoleToPersonTwoStageGeneratorGU {
    
    private static String TEMPLATE = "addMembershipOfProfessionalOrganisationRoleToPerson.ftl";
    ...
    @Override
    String getRoleType() {
        return "http://griffith.edu.au/ontology/hubextensions/MembershipOfProfessionalOrganisationRole";
    }
