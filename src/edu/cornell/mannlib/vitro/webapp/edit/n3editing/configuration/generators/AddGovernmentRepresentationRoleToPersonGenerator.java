...
public class AddGovernmentRepresentationRoleToPersonGenerator extends AddRoleToPersonTwoStageGeneratorGU {
    
    private static String TEMPLATE = "addGovernmentRepresentationRoleToPerson.ftl";
    ...
    @Override
    String getRoleType() {
        return "http://griffith.edu.au/ontology/hubextensions/GovernmentRepresentationRole";
    }
