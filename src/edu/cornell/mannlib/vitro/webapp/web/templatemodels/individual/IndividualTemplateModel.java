...
public class IndividualTemplateModel extends BaseIndividualTemplateModel {
    ...
    private static final String PROFILED_PERSON_CLASS = "http://griffith.edu.au/ontology/hubextensions/ResearchHubPerson";
    ...
    public boolean profiledPerson() {
        return isVClass(PROFILED_PERSON_CLASS);
    }
