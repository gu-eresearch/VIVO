...
public class IndividualDaoSDB extends IndividualDaoJena {
    ...
    @Override
    public Iterator<String> getAllForIndexIterator() {
        final List<String> list = 
            new LinkedList<String>();
        ...
        */
        ...
        String query =  "PREFIX ands: <http://www.ands.org.au/ontologies/ns/0.1/VITRO-ANDS.owl#> \n"+
        				"PREFIX guhubext: <http://griffith.edu.au/ontology/hubextensions/> \n"+
        				"PREFIX core: <http://vivoweb.org/ontology/core#> \n"+
        				"SELECT DISTINCT ?ind \n"+
							"WHERE { \n"+
							"			{ ?ind a guhubext:ResearchHubPerson . } \n"+
							"	 UNION 	{ ?ind a guhubext:ResearchHubGroup . } \n"+
							"	 UNION 	{ ?ind a guhubext:GrantProject . } \n"+
							"	 UNION 	{ ?ind a guhubext:ResearchHubPublication . } \n"+
							"	 UNION 	{ ?ind a ands:ResearchData . } \n"+
							"	 UNION 	{ ?ind a core:Service . } \n"+
							"}";
	    
							
		/*
		query =  "PREFIX ands: <http://www.ands.org.au/ontologies/ns/0.1/VITRO-ANDS.owl#> \n"+
        				"PREFIX guhubext: <http://griffith.edu.au/ontology/hubextensions/> \n"+
        				"PREFIX core: <http://vivoweb.org/ontology/core#> \n"+
        				"SELECT DISTINCT ?ind \n"+
							"WHERE { \n"+
							"			{ ?ind a guhubext:ResearchHubPerson . } \n"+
							"	 UNION 	{ ?ind a guhubext:GrantProject . } \n"+
							"	 UNION 	{ ?ind a guhubext:ResearchHubProject . } \n"+
							"	 UNION 	{ ?ind a guhubext:ResearchHubPublication . } \n"+
							"	 UNION 	{ ?ind a ands:ResearchData . } \n"+
							"	 UNION 	{ ?ind a core:Service . } \n"+
							"			 FILTER ( ?ind = <http://research-hub-dev.griffith.edu.au/individual/nff692bf373eeb9bfdbdf2b7147e07941>   ) \n"+
		...
		*/
        ...
        query =  "PREFIX ands: <http://www.ands.org.au/ontologies/ns/0.1/VITRO-ANDS.owl#> \n"+
        				...
        				"SELECT DISTINCT ?ind \n"+
							"WHERE { \n"+
							"			{ ?ind a guhubext:ResearchHubPublication . } \n"+							
							"} LIMIT 30";	
        ...
        */
        ...
        String query =  "PREFIX ands: <http://www.ands.org.au/ontologies/ns/0.1/VITRO-ANDS.owl#> \n"+
        				...
        				"SELECT DISTINCT ?ind \n"+
							...
							"	 UNION 	{ ?ind a ands:ResearchData . } \n"+
							"	 UNION 	{ ?ind a core:Service . } \n"+
							"	 FILTER ( ?ind = <http://research-hub-dev.griffith.edu.au/individual/n83b9bb1f0e0539a960bea4b4f55ca6c6> || ?ind = <http://research-hub-dev.griffith.edu.au/individual/nb485c924815d51231c08fb76d521d4a5> || ?ind = <http://research-hub-dev.griffith.edu.au/individual/n28a9d66ee8593024800acc59ae817eef> ) \n"+
							"}";
        */
	    Query q = QueryFactory.create(query);
	    DatasetWrapper w = getDatasetWrapper();
    ...
    @Override
    public Iterator<String> getAllForProfiledIndexIterator() {
        final List<String> list = 
            new LinkedList<String>();
