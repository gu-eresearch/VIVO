...
public class VivoDocumentModifiers implements javax.servlet.ServletContextListener{
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        modifiers.add(new GUPersonContextNodeFields(rdfServiceFactory));
        modifiers.add(new GUInformationResourceContextNodeFields(rdfServiceFactory));
        modifiers.add(new GUProjectContextNodeFields(rdfServiceFactory));
        modifiers.add(new GUGroupContextNodeFields(rdfServiceFactory));
