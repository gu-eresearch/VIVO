...
<#assign book_journal_nameProp 		= propertyGroups.pullProperty("http://griffith.edu.au/ontology/hubextensions/book_journal_name")!>
<#assign overview 					= propertyGroups.pullProperty("http://purl.org/ontology/bibo/abstract")!>
...
<div class="propertyGroup_tab_wrapper">
	...
	<#if overview?has_content> <#-- true when the property is in the list, even if not populated (when editing) -->
		<#if overview.statements?has_content> <#-- true when the property is in the list, even if not populated (when editing) -->
		...
		<h3>Publication Record</h3>
			...
			<ul class="property-list">
				...
				<table class="propertyTable">
					...
					<#if mostSpecificTypeProp?has_content>
						<#assign mostSpecificType = mostSpecificTypeProp.firstValue!>
						<tr>
							<td class="keyCol">
								Publication Type
							</td>
					...
					<#if book_journal_name?has_content> <#-- true when the property is in the list, even if not populated (when editing) -->
						<tr>
							<td class="keyCol">
								Published In
							</td>
							<td class="valueCol">
								...
								<#list book_journal_name as statement>
									${statement!}
								</#list>
								</span>
							</td>
					...
					<#if creators?has_content>
					 ...
					 <#-- Start Page -->
					<#assign pageStartProp = propertyGroups.pullProperty("http://purl.org/ontology/bibo/pageStart")!>
					<#if pageStartProp?has_content>
						<#assign pageStart = pageStartProp.firstValue!>
						<tr>
							<td class="keyCol">
								Start Page
							</td>
							<td class="valueCol">
								<li role="listitem" class="dataprop_text">  
									 <@p.objectProperty pageStartProp editable />
								</li>
							</td>
						</tr>
					</#if>
					 ...
					 <#-- End Page -->
					<#assign pageEndeProp = propertyGroups.pullProperty("http://purl.org/ontology/bibo/pageEnd")!>
					<#if pageEndeProp?has_content>
						<#assign pageEnd = pageEndeProp.firstValue!>
						<tr>
							<td class="keyCol">
								End Page
							</td>
							<td class="valueCol">
								<li role="listitem" class="dataprop_text">  
									 <@p.objectProperty pageEndeProp editable />
								</li>
							</td>
						</tr>
					</#if>
					...
					<#if issnProp?has_content>
						<#assign issn = issnProp.firstValue!>
						<tr>
							<td class="keyCol">
								ISSN
							</td>
							<td class="valueCol">
								<@p.objectProperty issnProp editable />
							</td>
						</tr>
					</#if>
					...
					<#if volumeProp?has_content>
						 <#assign volume = volumeProp.firstValue!>
						<tr>
							<td class="keyCol">
								Volume
							</td>
							<td class="valueCol">
								<li role="listitem" class="dataprop_text">  
									<@p.objectProperty volumeProp editable />
								</li>
							</td>
						</tr>
					</#if>
	...
	<#if subjectAreas?has_content> <#-- true when the property is in the list, even if not populated (when editing) -->
		<article class="sidebar-list property" role="article">
			...
			<ul class="subclass-property-list">
				<span itemprop="keywords"><@p.objectProperty subjectAreas editable /></span>
			</ul>
		</article>
	</#if>   
