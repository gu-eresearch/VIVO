...
<#assign description 		= propertyGroups.pullProperty("http://purl.org/dc/terms/description")!> 
...
<#assign temporal 			= propertyGroups.pullProperty("http://purl.org/dc/terms/temporal")!> 
<#assign spatial 			= propertyGroups.pullProperty("http://purl.org/dc/terms/spatial")!> 
...
<div id="breadcrumbs">
	...
	<li><a href="${urls.base}/collections">Collections</a>&nbsp;&nbsp;&raquo;</li>
	<li>
	<#if (title?length > 100)>
...
<section id="individual-intro" class="vcard person" role="region">
        ...
        <#assign individualImage>
            <@p.image individual=individual 
                      ...
                      placeholder="${urls.images}/placeholders/collection.thumbnail.jpg" />
        </#assign>
...
<div class="propertyGroup_tab_wrapper_collection">
		<section class="property-group non-person-entity record">
			...
			<article class="property" role="article" id="collection-record">
					...
					<table class="propertyTable">
							...
							<tr>
								...
								<td class="valueCol">
									<#list description.statements as statement>
										${statement.value}
										<@p.editingLinks "${description.localName}" statement editable />
									</#list>
								</td>
							</tr>
						</#if> 
						...
						<#if temporal?has_content> <#-- true when the property is in the list, even if not populated (when editing) -->
							<tr>
								...
								<td class="valueCol">
									<#list temporal.statements as statement>
										${statement.value}
										<@p.editingLinks "${temporal.localName}" statement editable />
									</#list>
								</td>
							</tr>
						</#if> 
						...
						<#if spatial?has_content> <#-- true when the property is in the list, even if not populated (when editing) -->
							<tr>
								...
								<td class="valueCol">
									<#list spatial.statements as statement>
										${statement.value}
						...
						<#-- START *******  statements for properties used in vitro-test collections -->
								...
								<#if publisher?has_content>
									<#if doi?has_content>
										<tr>
											...
											<td class="valueCol">
												<span>
												<#list collectors as coll>
													${coll!}<#if coll_has_next>,</#if>
												</#list>
												(${issued!}): ${theTitle[0]!}. ${publisher[0]!}. <a target="_blank" href="http://dx.doi.org/${doi[0]!}">http://dx.doi.org/${doi[0]!}</a>.  
												</span>
											</td>
										</tr>
									</#if>
		...
		<#-- isManagedBy -->
			...
			<#if hasCollector?has_content> <#-- true when the property is in the list, even if not populated (when editing) -->
				<article class="sidebar-list property" role="article">
					<h3>
						Collectors
					</h3>
					<ul class="subclass-property-list">
						<@p.objectProperty hasCollector editable />
					</ul>
				</article>
			</#if> 
        ...
        <article class="sidebar-list property" role="altmetrics">
                <h3>Altmetrics</h3>
                <ul class="subclass-property-list">
					<div class='altmetric-embed' data-badge-type='donut' data-doi="${doi[0]!}"></div>
                </ul>
        </article>
        </#if>				
...
<#-- social share parameters below here -->
<#-- social share parameters below here -->
<script type="text/javascript">stLight.options({publisher:
"5c6afb4b-e41b-4071-9b25-202b7bf5a1da", doNotHash: false, doNotCopy:
false, hashAddressBar: false});</script>
<script>
var options={ "publisher": "5c6afb4b-e41b-4071-9b25-202b7bf5a1da", "position": "left", "ad": { "visible": false, "openDelay": 5, "closeDelay": 0}, "chicklets": { "items": 
["twitter", "citeulike", "connotea", "googleplus", "facebook", "linkedin", "wordpress", "email", "sharethis"]}};
